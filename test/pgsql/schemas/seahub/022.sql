...
--
-- Name: notifications_devicetoken; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.notifications_devicetoken OWNER TO postgres;

--
-- Name: notifications_devicetoken_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.notifications_devicetoken_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.notifications_devicetoken_id_seq OWNER TO postgres;

--
-- Name: notifications_devicetoken_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.notifications_devicetoken_id_seq OWNED BY public.notifications_devicetoken.id;
...
--
-- Name: notifications_devicetoken id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.notifications_devicetoken ALTER COLUMN id SET DEFAULT nextval('public.notifications_devicetoken_id_seq'::regclass);
...
--
-- Name: notifications_devicetoken notifications_devicetoken_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: notifications_devicetoken notifications_devicetoken_token_user_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.notifications_devicetoken
    ADD CONSTRAINT notifications_devicetoken_token_user_key UNIQUE (token, "user");
