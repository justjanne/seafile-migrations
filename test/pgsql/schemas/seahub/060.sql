...
--
-- Name: message_usermessage_acc047cf; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX message_usermessage_acc047cf ON public.message_usermessage USING btree (to_email);


--
-- Name: message_usermessage_f50bd8c4; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX message_usermessage_f50bd8c4 ON public.message_usermessage USING btree (from_email);


--
-- Name: message_usermessage_from_email_1471e238c0f39573_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX message_usermessage_from_email_1471e238c0f39573_like ON public.message_usermessage USING btree (from_email varchar_pattern_ops);


--
-- Name: message_usermessage_to_email_15203cce5dd4f95c_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX message_usermessage_to_email_15203cce5dd4f95c_like ON public.message_usermessage USING btree (to_email varchar_pattern_ops);


--
-- Name: message_usermsgattachment_4b5c5c38; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX message_usermsgattachment_4b5c5c38 ON public.message_usermsgattachment USING btree (priv_file_dir_share_id);


--
-- Name: message_usermsgattachment_728fbd7e; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX message_usermsgattachment_728fbd7e ON public.message_usermsgattachment USING btree (user_msg_id);
...
--
-- Name: message_usermsgattachment f591a820f2a64883835a01b6fdb32c9a; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.message_usermsgattachment
    ADD CONSTRAINT f591a820f2a64883835a01b6fdb32c9a FOREIGN KEY (priv_file_dir_share_id) REFERENCES public.share_privatefiledirshare(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: message_usermsgattachment user_msg_id_3f10b9ac43610631_fk_message_usermessage_message_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.message_usermsgattachment
    ADD CONSTRAINT user_msg_id_3f10b9ac43610631_fk_message_usermessage_message_id FOREIGN KEY (user_msg_id) REFERENCES public.message_usermessage(message_id) DEFERRABLE INITIALLY DEFERRED;
