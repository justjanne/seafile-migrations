...
--
-- Name: base_clientlogintoken_token_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX base_clientlogintoken_token_like ON public.base_clientlogintoken USING btree (token varchar_pattern_ops);


--
-- Name: base_clientlogintoken_username; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX base_clientlogintoken_username ON public.base_clientlogintoken USING btree (username);


--
-- Name: base_clientlogintoken_username_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX base_clientlogintoken_username_like ON public.base_clientlogintoken USING btree (username varchar_pattern_ops);
