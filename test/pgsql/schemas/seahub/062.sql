...
--
-- Name: profile_profile_3d5d3631; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX profile_profile_3d5d3631 ON public.profile_profile USING btree (list_in_address_book);
...
--
-- Name: revision_tag_revisiontags_14c4b06b; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX revision_tag_revisiontags_14c4b06b ON public.revision_tag_revisiontags USING btree (username);


--
-- Name: revision_tag_revisiontags_5de09a8d; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX revision_tag_revisiontags_5de09a8d ON public.revision_tag_revisiontags USING btree (revision_id);


--
-- Name: revision_tag_revisiontags_76f094bc; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX revision_tag_revisiontags_76f094bc ON public.revision_tag_revisiontags USING btree (tag_id);


--
-- Name: revision_tag_revisiontags_9a8c79bf; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX revision_tag_revisiontags_9a8c79bf ON public.revision_tag_revisiontags USING btree (repo_id);


--
-- Name: revision_tag_revisiontags_repo_id_6312259cbea1b35a_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX revision_tag_revisiontags_repo_id_6312259cbea1b35a_like ON public.revision_tag_revisiontags USING btree (repo_id varchar_pattern_ops);


--
-- Name: revision_tag_revisiontags_revision_id_4b68909bc0c2461b_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX revision_tag_revisiontags_revision_id_4b68909bc0c2461b_like ON public.revision_tag_revisiontags USING btree (revision_id varchar_pattern_ops);


--
-- Name: revision_tag_revisiontags_username_20b7304041e528dd_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX revision_tag_revisiontags_username_20b7304041e528dd_like ON public.revision_tag_revisiontags USING btree (username varchar_pattern_ops);


--
-- Name: revision_tag_tags_name_7ae4fa8cdb7895c1_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX revision_tag_tags_name_7ae4fa8cdb7895c1_like ON public.revision_tag_tags USING btree (name varchar_pattern_ops);


--
-- Name: role_permissions_adminrole_email_351d25714cbc0315_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX role_permissions_adminrole_email_351d25714cbc0315_like ON public.role_permissions_adminrole USING btree (email varchar_pattern_ops);
...
--
-- Name: share_extragroupssharepermission_0e939a4f; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX share_extragroupssharepermission_0e939a4f ON public.share_extragroupssharepermission USING btree (group_id);


--
-- Name: share_extragroupssharepermission_9a8c79bf; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX share_extragroupssharepermission_9a8c79bf ON public.share_extragroupssharepermission USING btree (repo_id);


--
-- Name: share_extragroupssharepermission_repo_id_2a3a75a8540bc29c_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX share_extragroupssharepermission_repo_id_2a3a75a8540bc29c_like ON public.share_extragroupssharepermission USING btree (repo_id varchar_pattern_ops);


--
-- Name: share_extrasharepermission_9a8c79bf; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX share_extrasharepermission_9a8c79bf ON public.share_extrasharepermission USING btree (repo_id);


--
-- Name: share_extrasharepermission_e4fb1dad; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX share_extrasharepermission_e4fb1dad ON public.share_extrasharepermission USING btree (share_to);


--
-- Name: share_extrasharepermission_repo_id_3cfebdac30440f6_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX share_extrasharepermission_repo_id_3cfebdac30440f6_like ON public.share_extrasharepermission USING btree (repo_id varchar_pattern_ops);


--
-- Name: share_extrasharepermission_share_to_4a43e2c9a864df4a_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX share_extrasharepermission_share_to_4a43e2c9a864df4a_like ON public.share_extrasharepermission USING btree (share_to varchar_pattern_ops);
...
--
-- Name: tags_filetag_10634818; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tags_filetag_10634818 ON public.tags_filetag USING btree (uuid_id);


--
-- Name: tags_filetag_76f094bc; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tags_filetag_76f094bc ON public.tags_filetag USING btree (tag_id);


--
-- Name: tags_fileuuidmap_9a8c79bf; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tags_fileuuidmap_9a8c79bf ON public.tags_fileuuidmap USING btree (repo_id);


--
-- Name: tags_fileuuidmap_c5bf47d4; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tags_fileuuidmap_c5bf47d4 ON public.tags_fileuuidmap USING btree (repo_id_parent_path_md5);


--
-- Name: tags_fileuuidmap_repo_id_1f14e33c086aaf1f_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tags_fileuuidmap_repo_id_1f14e33c086aaf1f_like ON public.tags_fileuuidmap USING btree (repo_id varchar_pattern_ops);


--
-- Name: tags_fileuuidmap_repo_id_parent_path_md5_2d4d978cd92c57e9_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tags_fileuuidmap_repo_id_parent_path_md5_2d4d978cd92c57e9_like ON public.tags_fileuuidmap USING btree (repo_id_parent_path_md5 varchar_pattern_ops);


--
-- Name: tags_tags_name_2943165e455ac124_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tags_tags_name_2943165e455ac124_like ON public.tags_tags USING btree (name varchar_pattern_ops);
...
--
-- Name: trusted_ip_trustedip_957b527b; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX trusted_ip_trustedip_957b527b ON public.trusted_ip_trustedip USING btree (ip);


--
-- Name: trusted_ip_trustedip_ip_787e85beaf43b5d8_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX trusted_ip_trustedip_ip_787e85beaf43b5d8_like ON public.trusted_ip_trustedip USING btree (ip varchar_pattern_ops);


--
-- Name: two_factor_phonedevice_user_740856725d4538c7_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX two_factor_phonedevice_user_740856725d4538c7_like ON public.two_factor_phonedevice USING btree ("user" varchar_pattern_ops);


--
-- Name: two_factor_staticdevice_user_135f61846e27ca8_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX two_factor_staticdevice_user_135f61846e27ca8_like ON public.two_factor_staticdevice USING btree ("user" varchar_pattern_ops);


--
-- Name: two_factor_statictoken_9379346c; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX two_factor_statictoken_9379346c ON public.two_factor_statictoken USING btree (device_id);


--
-- Name: two_factor_statictoken_94a08da1; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX two_factor_statictoken_94a08da1 ON public.two_factor_statictoken USING btree (token);


--
-- Name: two_factor_statictoken_token_4e2e41db204f0923_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX two_factor_statictoken_token_4e2e41db204f0923_like ON public.two_factor_statictoken USING btree (token varchar_pattern_ops);


--
-- Name: two_factor_totpdevice_user_325bd6ae77384d4f_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX two_factor_totpdevice_user_325bd6ae77384d4f_like ON public.two_factor_totpdevice USING btree ("user" varchar_pattern_ops);
...
--
-- Name: revision_tag_revisiontags revision_tag_re_tag_id_37c2d76166c50597_fk_revision_tag_tags_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.revision_tag_revisiontags
    ADD CONSTRAINT revision_tag_re_tag_id_37c2d76166c50597_fk_revision_tag_tags_id FOREIGN KEY (tag_id) REFERENCES public.revision_tag_tags(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: tags_filetag tags_filetag_tag_id_39c4746ee9d70b71_fk_tags_tags_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tags_filetag
    ADD CONSTRAINT tags_filetag_tag_id_39c4746ee9d70b71_fk_tags_tags_id FOREIGN KEY (tag_id) REFERENCES public.tags_tags(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: tags_filetag tags_filetag_uuid_id_5e2dc8ebbab85301_fk_tags_fileuuidmap_uuid; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tags_filetag
    ADD CONSTRAINT tags_filetag_uuid_id_5e2dc8ebbab85301_fk_tags_fileuuidmap_uuid FOREIGN KEY (uuid_id) REFERENCES public.tags_fileuuidmap(uuid) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: two_factor_statictoken two_fa_device_id_55a7b345293a7c6c_fk_two_factor_staticdevice_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.two_factor_statictoken
    ADD CONSTRAINT two_fa_device_id_55a7b345293a7c6c_fk_two_factor_staticdevice_id FOREIGN KEY (device_id) REFERENCES public.two_factor_staticdevice(id) DEFERRABLE INITIALLY DEFERRED;
