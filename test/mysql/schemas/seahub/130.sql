...
CREATE TABLE IF NOT EXISTS `profile_profile` (
  ...
  `is_manually_set_contact_email` boolean DEFAULT 0,
...
CREATE TABLE `org_saml_config` (
  ...
  `domain_verified` boolean NOT NULL DEFAULT 0,
