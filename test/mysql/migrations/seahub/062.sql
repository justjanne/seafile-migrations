...
ALTER TABLE `sysadmin_extra_userloginlog` ADD COLUMN `login_success` boolean NOT NULL default 1;
ALTER TABLE `profile_profile` ADD COLUMN `list_in_address_book` boolean NOT NULL default 0;
