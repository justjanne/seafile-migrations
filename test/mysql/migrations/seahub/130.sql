...
ALTER TABLE organizations_orgsettings ADD COLUMN `is_active` boolean NOT NULL DEFAULT 1;

ALTER TABLE repo_metadata ADD COLUMN tags_enabled boolean NULL;
...
ALTER TABLE repo_metadata ADD COLUMN ocr_enabled boolean NULL;
